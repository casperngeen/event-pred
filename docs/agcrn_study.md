...
*Companion to `update_2026_08.md` §2 (the pivot) and `docs/graph_definition.md`.
...
(`stg/structure/`) as the standalone deliverable. This study runs AGCRN honestly
...
rank-detectable, which is what `stg/structure/` is built for and what a neural Δ
